...
-- Généré le :  Mar 21 Août 2018 à 15:36
...
INSERT INTO `1ta_replies` (`id`, `id_admin`, `id_classroom`, `id_student`, `serie`, `reply1`, `reply2`, `reply3`, `reply4`, `reply5`, `reply6`, `reply7`, `reply8`, `reply9`, `open_reply`) VALUES
(2, 1, 5, 19, 'A', 1, 1, 1, 2, 2, 2, 2, 2, 2, 'ALLO\nALLO');
...
CREATE TABLE `1ta_stats` (
  ...
  `stats_envi` float NOT NULL,
  `stats_sante` float NOT NULL,
  `stats_social` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
